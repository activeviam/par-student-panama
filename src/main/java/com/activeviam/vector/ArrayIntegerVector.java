 ...
 * @author ActiveViam
 */
public class ArrayIntegerVector extends AArrayVector {
	 ...
	 */
	public ArrayIntegerVector(int[] underlying) {
	 ...
	 */
	public static ArrayIntegerVector of(final int... values) {
		return new ArrayIntegerVector(values);
	}
	...
	public void copyFrom(IVector vector) {
		...
		final int[] rightArray = ((ArrayIntegerVector) vector).getUnderlying();
		final int[] leftArray = getUnderlying();
